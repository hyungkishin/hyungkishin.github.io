<!--
출처: epoko77-ai/im-not-ai (Humanize KR), MIT License, Copyright (c) 2026 epoko77-ai.
원본: .claude/skills/humanize-korean/references/ai-tell-taxonomy.md
이 블로그 레포에 SSOT 참조용으로 비치. 톤 가드(scripts/tone-guard.mjs)의 패턴 ID가 이 문서를 가리킨다.
글을 고칠 때 한국어 AI 티(번역투/관용구/리듬)를 판단하는 기준 문서.
-->
