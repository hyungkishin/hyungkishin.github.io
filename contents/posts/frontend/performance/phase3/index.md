---
title: "JS 번들부터 손댄 이유 (어디부터 잡아야 하는가)"
date: 2025-05-03
update: 2024-05-03
tags:
  - front-end
...
> 시리즈의 1부 (현 phase3) 는 그 *진단의 시작* 자리예요.
>
> 측정해보니 JS 번들이 화면 무게에 비해 컸어요.  
> main thread가 그만큼 일을 받았고, TBT가 빨갰습니다.  
> 그래서 *첫 가시적 손해* 인 JS 번들부터 손댔습니다.
>
> 다만 이 글은 *한 layer* 만 다룹니다.  
> 번들을 줄여도 CLS / FCP / LCP / 렌더링 경계 / CDN 같은 다른 layer 손해는 그대로 남아요.  
> 그건 2부, 3부, 4부, 5부에서 차례로.
...
번들을 줄이고 점수가 따라 오를 거라고 봤어요.  
거의 안 움직였습니다. 그 자리에 *CLS / FCP / TBT* 라는 다른 layer가 따로 점수를 깎고 있었어요.  
2부에서 그 자리를 잡습니다.
