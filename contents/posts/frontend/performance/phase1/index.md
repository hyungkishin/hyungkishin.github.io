...
그런게 있다 ? 순조로운 인수인계 + 여유로운 프로젝트 + 이상한 느낌

( 아니겠지 생각이 들때쯤. 부장님 의 스윗 + 다급한 목소리 )
...
**검색 노출 하락 → 사용자 이탈 → 수익 저하**로 이어지는 구조적 위기였다.
...
![amp 안됌 1 스택 - Vercel 에 컨펌까지 받았대 ;;](img_3.png)
![응단됌 - 2 스택](img_6.png)
![그만해 .. - 3 스택](img_7.png)
![아 ... ? ](img_8.png)
...
- 시간을 아껴주신 분들
  - [버셀에 문의까지 주신분](https://github.com/vercel/next.js/discussions/76918)
  - [그외-1](https://github.com/vercel/next.js/issues/64354)
  - [그외-2](https://www.reddit.com/r/nextjs/comments/1dpuvj7/how_do_i_configure_a_page_to_be_amp_in_app_router/)
