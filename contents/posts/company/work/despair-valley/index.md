...
국비 지원 학원에서 웹개발을 배우기 시작했을 때, 나는 백엔드 개발자가 되고 싶었다.
현실은 달랐다. 첫 직장에서 얼떨결에 맡은 업무는 프론트엔드였고, 그렇게 몇 년을 프론트엔드 개발자로 살았다.

그것도 나쁘지 않았다. 새로 이직한 회사에서 첫 프로젝트를 맡기 전까지는.

### TF 팀의 도전

입사할 무렵 신규 간편결제 수단으로 네이버페이를 붙여야 하는 일이 있었다.
그때 나는 "결제수단 하나 추가하는 데 얼마나 걸리겠어" 정도로 생각했다. 다른 개발자들도 크게 다르지 않았던 걸로 기억한다.

이윽고 파트장님이 어두운 표정으로 긴급 회의를 하자고 했다. 팀원들은 불안한 눈빛으로 회의실에 하나둘 들어갔다.

기능이 추가될 코드를 열어보고 나서야 다들 표정이 왜 어두웠는지 알았다. "얼마나 걸리겠어"는 착각이었다. 볼륨이 너무 컸다.

일정표를 보는 눈빛에 불안이 가득했다. "이 모든 걸 어떻게 해내라는 거야?" 한 개발자가 한숨을 내쉬었다.
"새 기능을 넣으려면 기존 시스템에 미칠 영향도 다 훑어야 해." 다른 개발자가 걱정스럽게 덧붙였다.

긴 회의는 전쟁터였고, 결론은 결제 리뉴얼 프로젝트와 TF 팀 차출이었다.
그런데 이런. 내가 차출 대상자였다.
...
그 말과 함께 팀 전원이 시간이 멈춘 듯 조용해졌다. 고요한 숨소리만 들렸다.션
모인 사람들이 전부 프론트엔드로 오래 근무한 사람들이었기 때문이다.

![난 프론트를 준비했지 x 3](img_5.png)

정적을 깨려고 내가 먼저 운을 뗐다.

"저희 아무래도 백엔드 지원이 필요한데, 다른 팀에서 받으면 안 될까요?"

"다른 팀 지원은 어려워요. TF 내부에서 정해야 합니다."

그렇게 다음 미팅까지 내부에서 포지션을 정하기로 하고 미팅은 끝났다.
...
그런데 게임을 제안한 사람이 당첨되는 게 국룰이라는 걸 잊고 있었다.
...
살면서 내 선택으로 삶이 바뀐 경험 TOP 3에 드는 결정이었다.
...
어느덧 오픈 일정이 코앞이었다. 나는 할당된 일을 쳐내려고 밤샘 야근을 계속했다.
그렇게 1년을 무리했다. 번아웃이 올 법도 했는데, 프로젝트를 성공적으로 오픈하면서 감격스럽게 마무리했다.
놀랍게도 오픈 당일 TF가 마주한 장애 대응 건은 0에 수렴했다.

### 능력에 대한 자각

프로젝트의 성공은 자신감을 키웠다. 동시에 더닝 크루거 효과로 내 능력을 과대평가하는 순간도 왔다.

"아니 이걸 모른다고?"

계단으로 치면 한 번에 네 칸씩 오르는 느낌이랄까. 어쨌든 올라가지긴 한 모양이다.
...
개발자는 현실의 비즈니스를 코드로 풀어낸다. 그 과정에서 막히는 지점을 만나면 학습하고, 코드를 더 써서 넘어간다.
...
생각이 꼬리를 무는 게 나쁜 건 아니다. 하지만 결국 나를 꺾이게 만든다는 사실은 고칠 지점이었다.
그전까지 나는 "꺾여도 계속하는 마음"이 만능 영양제인 줄 알았다.
...
![너라고 다를것 같아 ?](https://r2.jjalbot.com/2023/03/YAD8OMcD52.webp)
