...
모든 내용을 단일 문서에 담았을 때,
내용이 비대해지고 실제 활용도를 떨어뜨렸다.

> 이 문제를 해결하기 위해서는  
> 어떤 기준으로 문서의 범위를 정할지 먼저 결정해야 한다.
...
이 질문에 답하지 못했다면, 문서는 쉽게 방향을 잃을 가능성이 높다.

- 구현을 위한 문서라면 데이터 구조와 흐름이 중요하고  
- 정책 공유 문서라면 용어 정의와 예외 규칙이 중요하며  
- 온보딩 문서라면 전체 구조와 맥락이 중요하다  

목적을 명확히 하지 않으면, 문서는 여러 기대를 동시에 충족시키려 하게 된다.    
그리고 높은 확률로 거대한 문서를 작성하게 된다.

> 마음은 이해하지만, 거대한 문서는 한계가 있다.
...
서로 다른 요구를 하나의 문서에 담으려 할수록  
가독성과 상세함 사이의 충돌이 발생한다.

> 균형 잡힌 글은 트레이드 오프가 존재한다.
---
...
문서는 자신이 갖는 목적에 집중할 때 비로소 가치가 드러난다.

> 가치 있는 문서는 어떤 목적과 상황에 쓰일까?

---

## 상황에 따라 필요한 문서
문서가 해결하려는 문제가 다르면 형태도 달라진다.

업무 환경과 도메인의 특성에 따라  
문서의 종류와 깊이는 크게 달라진다.  

상황에 따라 효과적인 문서 유형은 다음과 같다.
...
상황별로 적절한 문서 유형은 존재하지만
실제 작성 단계에서는 여전히 어려움이 남는다.

특히 이러한 문서가 조직 내에 축적되어 있지 않은 경우라면  
문서 작성의 부담은 더욱 커진다.

부담을 덜고 효과적인 문서로 시작해 볼 수는 없을까?
> 다행히, 효과적인 문서는 몇 가지 공통점을 보인다.
...
협업에서 실제로 잘 활용되는 문서에는 몇 가지 공통점이 있다.
...
따라서 문서는 결과물이 아니라 지속적으로 관리되어야 할 대상에 가깝다.

완벽한 문서를 만드는 것보다  
수정하기 쉬운 구조를 만드는 것이 더 중요하다.

문서가 부족하면 개발자가 정책을 대신 정의하게 되고,  
반대로 문서가 과하면 아무도 읽지 않는다.
...
다음 질문에 답할 수 있는 문서라면, 훌륭한 문서라고 생각한다.
