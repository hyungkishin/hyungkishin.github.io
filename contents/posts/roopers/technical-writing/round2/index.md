...
한 문서에 모든 것을 담으려다  
결국 아무도 읽지 않는 문서가 되기도 한다.

결국 문서의 목적과 범위를 먼저 정하지 않으면 해결되지 않는다.
...
목적을 명확히 하지 않으면 문서는 여러 기대를 동시에 충족시키려 하게 되고,  
결국 아무도 만족시키지 못하는 형태가 된다.

> 현실적으로 모두를 만족시키는 단일 문서는 만들기 어렵다.
...
실제로 협업에서 잘 쓰이는 문서에는 몇 가지 공통점이 있다.
